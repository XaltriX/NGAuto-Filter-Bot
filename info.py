...
PICS = (environ.get('PICS', 'https://files.catbox.moe/i19rc6.jpg')).split()  # Sample pic
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003462996661")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
